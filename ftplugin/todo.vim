...
nnoremap <script> <silent> <buffer> <localleader>u :call todo#txt#replace_date()<CR>
vnoremap <script> <silent> <buffer> <localleader>u :call todo#txt#replace_date()<CR>

" Mark done {{{2
nnoremap <script> <silent> <buffer> <localleader>d :call todo#txt#mark_as_done()<CR>
vnoremap <script> <silent> <buffer> <localleader>d :call todo#txt#mark_as_done()<CR>

" Mark all done {{{2
nnoremap <script> <silent> <buffer> <localleader>X :call todo#txt#mark_all_as_done()<CR>

" Remove completed / do a clean {{{2
