...
" Mappings {{{1
" Sort tasks {{{2
nnoremap <script> <silent> <buffer> <localleader>ts :%sort<CR>
vnoremap <script> <silent> <buffer> <localleader>ts :sort<CR>
nnoremap <script> <silent> <buffer> <localleader>ts@ :%call todo#txt#sort_by_context()<CR>
vnoremap <script> <silent> <buffer> <localleader>ts@ :call todo#txt#sort_by_context()<CR>
nnoremap <script> <silent> <buffer> <localleader>ts+ :%call todo#txt#sort_by_project()<CR>
vnoremap <script> <silent> <buffer> <localleader>ts+ :call todo#txt#sort_by_project()<CR>
nnoremap <script> <silent> <buffer> <localleader>tsc :%call todo#txt#sort_by_date()<CR>
vnoremap <script> <silent> <buffer> <localleader>tsc :call todo#txt#sort_by_date()<CR>
nnoremap <script> <silent> <buffer> <localleader>tsd :%call todo#txt#sort_by_due_date()<CR>
...
nnoremap <script> <silent> <buffer> <localleader>tu :call todo#txt#replace_date()<CR>
vnoremap <script> <silent> <buffer> <localleader>tu :call todo#txt#replace_date()<CR>

" Mark done {{{2
nnoremap <script> <silent> <buffer> <localleader>td :call todo#txt#mark_as_done()<CR>
